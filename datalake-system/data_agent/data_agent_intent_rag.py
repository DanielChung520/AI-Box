...
INTENT_TEMPLATES = [
    # === 庫存查詢 ===
    {
        "id": "inv_001",
        "query": "查詢 W01 倉庫的庫存",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W01'",
        "type": "query_inventory",
    },
    {
        "id": "inv_002",
        "query": "查W01 庫房每個料號存量",
        "sql": "SELECT img01, SUM(img10) FROM mart_inventory_wide WHERE img02 = 'W01' GROUP BY img01",
        "type": "statistics",
    },
    {
        "id": "inv_003",
        "query": "計算各倉庫的總庫存量",
        "sql": "SELECT img02, SUM(img10) FROM mart_inventory_wide GROUP BY img02",
        "type": "statistics",
    },
    {
        "id": "inv_004",
        "query": "查詢料號 10-0001 的庫存信息",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img01 = '10-0001'",
        "type": "query_inventory",
    },
    {
        "id": "inv_005",
        "query": "列出所有負庫存的物料",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img10 < 0",
        "type": "query_inventory",
    },
    {
        "id": "inv_006",
        "query": "列出前 10 個庫存量最多的物料",
        "sql": "SELECT * FROM mart_inventory_wide ORDER BY img10 DESC LIMIT 10",
        "type": "query_inventory",
    },
    {
        "id": "inv_007",
        "query": "統計 W03 成品倉的總庫存量",
        "sql": "SELECT SUM(img10) FROM mart_inventory_wide WHERE img02 = 'W03'",
        "type": "statistics",
    },
    {
        "id": "inv_008",
        "query": "計算各倉庫的平均庫存量",
        "sql": "SELECT img02, AVG(img10) FROM mart_inventory_wide GROUP BY img02",
        "type": "statistics",
    },
    {
        "id": "inv_009",
        "query": "查詢 2024 年有多少筆採購進貨",
        "sql": "SELECT COUNT(*) FROM mart_work_order_wide WHERE tlf19 = '101' AND tlf06 LIKE '2024%'",
    ...
    },
    {
        "id": "inv_011",
        "query": "W02 倉有多少庫存",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W02'",
        "type": "query_inventory",
    },
    {
        "id": "inv_012",
        "query": "給我 W03 的庫存資料",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W03'",
        "type": "query_inventory",
    },
    {
        "id": "inv_013",
    ...
    },
    {
        "id": "inv_014",
        "query": "每個料號的庫存量",
        "sql": "SELECT img01, SUM(img10) FROM mart_inventory_wide GROUP BY img01",
        "type": "statistics",
    },
    {
        "id": "inv_015",
    ...
    },
    {
        "id": "inv_016",
        "query": "總計 W01 倉庫的庫存",
        "sql": "SELECT SUM(img10) FROM mart_inventory_wide WHERE img02 = 'W01'",
        "type": "statistics",
    },
    {
        "id": "inv_017",
    ...
    },
    {
        "id": "inv_020",
        "query": "庫存量最高的 5 個物料",
        "sql": "SELECT * FROM mart_inventory_wide ORDER BY img10 DESC LIMIT 5",
        "type": "query_inventory",
    },
    {
        "id": "inv_021",
        "query": "找出庫存最少的 10 個料號",
        "sql": "SELECT * FROM mart_inventory_wide ORDER BY img10 ASC LIMIT 10",
        "type": "query_inventory",
    },
    {
        "id": "inv_022",
        "query": "2025 年 1 月的採購記錄",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf06 LIKE '2025-01%'",
        "type": "query_transaction",
    },
    {
        "id": "inv_023",
        "query": "最近 30 天的進貨",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf19 = '101' ORDER BY tlf06 DESC LIMIT 100",
        "type": "query_transaction",
    },
    {
        "id": "inv_024",
    ...
    },
    {
        "id": "inv_025",
        "query": "W05 倉有什麼存貨",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W05'",
        "type": "query_inventory",
    },
    {
        "id": "inv_026",
        "query": "計算 W01 加 W02 的庫存總和",
        "sql": "SELECT SUM(img10) FROM mart_inventory_wide WHERE img02 IN ('W01', 'W02')",
        "type": "statistics",
    },
    {
        "id": "inv_027",
        "query": "料號 RM01-003 的庫存",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img01 = 'RM01-003'",
        "type": "query_inventory",
    },
    {
        "id": "inv_028",
        "query": "各倉庫庫存數量統計",
        "sql": "SELECT img02, COUNT(*) FROM mart_inventory_wide GROUP BY img02",
        "type": "statistics",
    },
    {
        "id": "inv_029",
    ...
    },
    {
        ...
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf02 = 'W04' LIMIT 100",
        "type": "query_transaction",
    },
    # === 料件主檔查詢 ===
    {
        ...
        "sql": "SELECT ima01, ima02, ima021 FROM mart_inventory_wide WHERE ima01 = '10-0001'",
        "type": "query_item",
    },
    {
        "id": "ima_002",
        "query": "列出所有料件",
        "sql": "SELECT * FROM mart_inventory_wide LIMIT 100",
        "type": "query_item",
    },
    {
        "id": "ima_003",
        "query": "料號 10-0001 是什麼",
        "sql": "SELECT * FROM mart_inventory_wide WHERE ima01 = '10-0001'",
        "type": "query_item",
    },
    {
        "id": "ima_004",
        "query": "查詢所有料件的品名",
        "sql": "SELECT ima01, ima02 FROM mart_inventory_wide",
        "type": "query_item",
    },
    {
        "id": "ima_005",
        "query": "有多少種料件",
        "sql": "SELECT COUNT(*) FROM mart_inventory_wide",
        "type": "calculate_count",
    },
    # === 訂單查詢 ===
    {
    ...
    },
    {
        "id": "pur_002",
        "query": "查詢所有採購進貨交易",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf19 = '101' LIMIT 100",
        "type": "query_transaction",
    },
    {
        "id": "pur_003",
        "query": "按供應商統計採購量",
        "sql": "SELECT tlf14, SUM(tlf10) FROM mart_work_order_wide WHERE tlf19 = '101' GROUP BY tlf14",
        "type": "statistics",
    },
    {
        "id": "pur_004",
        "query": "計算 2024 年採購總數量",
        "sql": "SELECT SUM(tlf10) FROM mart_work_order_wide WHERE tlf19 = '101' AND tlf06 LIKE '2024%'",
        "type": "statistics",
    },
    {
        "id": "pur_005",
        "query": "10-0003 上個月的採購交易",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf01 = '10-0003' AND tlf19 = '101' AND tlf06 >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)",
        "type": "query_transaction",
    },
    {
        "id": "pur_006",
        "query": "查詢料號 10-0001 的採購記錄",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf01 = '10-0001' AND tlf19 = '101'",
        "type": "query_transaction",
    },
    {
        "id": "pur_007",
        "query": "上個月的採購進貨",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf19 = '101' AND tlf06 >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)",
        "type": "query_transaction",
    },
    {
        "id": "pur_008",
        "query": "RM05-008 買進多少",
        "sql": "SELECT SUM(tlf10) FROM mart_work_order_wide WHERE tlf01 = 'RM05-008' AND tlf19 = '101'",
        "type": "statistics",
    },
    {
        "id": "pur_009",
    ...
    },
    {
        ...
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf01 = 'RM05-008' AND tlf19 = '101' AND tlf06 >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)",
        "type": "query_transaction",
    },
    # === 銷售交易查詢 (tlf) ===
    {
        "id": "sal_001",
        "query": "2024 年銷售出庫筆數",
        "sql": "SELECT COUNT(*) FROM mart_work_order_wide WHERE tlf19 = '202' AND tlf06 LIKE '2024%'",
        "type": "calculate_count",
    },
    {
        "id": "sal_002",
        "query": "查詢所有銷貨記錄",
        "sql": "SELECT * FROM mart_work_order_wide WHERE tlf19 = '202' LIMIT 100",
        "type": "query_transaction",
    },
    {
        "id": "sal_003",
    ...
    },
    {
        "id": "sal_004",
        "query": "RM05-008 賣出多少",
        "sql": "SELECT SUM(tlf10) FROM mart_work_order_wide WHERE tlf01 = 'RM05-008' AND tlf19 = '202'",
        "type": "statistics",
    },
    {
        "id": "sal_005",
    ...
    # === 庫位相關 ===
    {
        ...
        "sql": "SELECT DISTINCT img03 FROM mart_inventory_wide WHERE img02 = 'W01'",
        "type": "query_inventory",
    },
    {
        "id": "loc_002",
        "query": "某儲位的庫存",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W01' AND img03 = 'LOC001'",
        "type": "query_inventory",
    },
    # === 變化表達方式 ===
    {
    ...
    },
    {
        "id": "var_002",
        "query": "現在 W02 倉有多少貨",
        "sql": "SELECT SUM(img10) FROM mart_inventory_wide WHERE img02 = 'W02'",
        "type": "statistics",
    },
    {
        "id": "var_003",
    ...
    },
    {
        "id": "var_004",
        "query": "成品倉各料號庫存",
        "sql": "SELECT img01, SUM(img10) FROM mart_inventory_wide WHERE img02 = 'W03' GROUP BY img01",
        "type": "statistics",
    },
    {
        "id": "var_005",
        "query": "顯示 W04 的庫存",
        "sql": "SELECT * FROM mart_inventory_wide WHERE img02 = 'W04'",
        "type": "query_inventory",
    },
]
