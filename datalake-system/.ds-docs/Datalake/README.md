...
**datalake-system 為獨立示範系統**，不依賴 AI-Box。Data-Agent、Dashboard、Datalake、Warehouse Manager Agent 均使用 `datalake-system/venv`。

Datalake System 提供數據存儲、數據字典管理和 Schema 管理功能。根據 Data-Agent 規格書，**Data Agent 屬於 Datalake 系統（外部系統）**，不屬於 AI-Box。
...
- [JP-PoC 專案文檔](./JP-PoC/README.md) - JP_CASE 客戶需求、專案需求規格、Tiptop 模擬系統擴展規格
- [Datalake-System 服務部署說明](./Datalake-System-服務部署說明.md) - **完整部署指南**（Datalake、Data-Agent、Tiptop、Streamlit Dashboard）
- [快速開始指南](./QUICK_START.md)
- [Data-Agent 規格書（模擬第三方，目前代碼狀況）](./Data-Agent-規格書.md)
- [Data-Agent 50 場景測試計劃（語言轉 SQL + 異常處理）](../DAta-Agent/testing/Data-Agent-50場景測試計劃.md)
- [Data-Agent → DuckDB → SeaweedFS E2E 測試計劃](./Data-Agent-DuckDB-SeaweedFS-E2E測試計劃.md)
- [Data-Agent 規格書 (High-Performance DataLake 版)](../../docs/系统设计文档/核心组件/Agent平台/Data-Agent-規格書.md)
