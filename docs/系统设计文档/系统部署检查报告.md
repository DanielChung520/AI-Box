...
**创建人**: Daniel Chung
**最后修改日期**: 2025-12-29
**关联文档**: [部署架构](./核心组件/部署架构.md)、[开发环境设置指南](./开发环境设置指南.md)
...
- ✅ [部署架构.md](./核心组件/部署架构.md) - 已更新（2025-12-29）
...
- ✅ [SeaweedFS使用指南.md](./核心组件/SeaweedFS使用指南.md) - 已创建（2025-12-29）
  - 包含双服务部署架构说明
  - 包含 Buckets 配置说明
  - 包含 S3 API 使用示例
...
- [部署架构](./核心组件/部署架构.md) - Kubernetes 部署说明
