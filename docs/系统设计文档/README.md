...
- 2026-01-02：更新文件上传架构说明链接（v2.0 → v3.0），整合文件管理、状态管理、文件存储系统等内容
...
**详细文档**：[强化RAG系统.md](./核心组件/文件上傳向量圖譜/强化RAG系统.md)
...
**详细文档**：[知识图谱系统.md](./核心组件/文件上傳向量圖譜/知识图谱系统.md)
...
**详细文档**：[Ontology系统.md](./核心组件/文件上傳向量圖譜/Ontology系统.md)
...
**详细文档**：[文件上传架构说明](./核心组件/文件上傳向量圖譜/上傳的功能架構說明-v3.0.md)
...
- **系统参数配置策略**：双层配置架构（.env + ArangoDB system_configs）

**详细文档**：[部署架构.md](./核心组件/系統管理/部署架构.md)

### 12. Personal Data / RoLA（规划中）
...
- [Ontology系统](./核心组件/文件上傳向量圖譜/Ontology系统.md) - 3-tier架构（base/domain/major）
...
- [部署架构](./核心组件/系統管理/部署架构.md) - 混合部署、k8s、Redis Worker、系统参数配置策略
- [部署架构-参数策略符合性检核](./核心组件/系統管理/部署架构-参数策略符合性检核.md) - 参数使用策略符合性检核报告
- [负载均衡器API文档](./核心组件/系統管理/负载均衡器API文档.md) - 负载均衡器 API 使用说明
- [SeaweedFS 使用指南](./核心组件/系統管理/SeaweedFS使用指南.md) - SeaweedFS 使用指南和 API 示例
...
开发过程中的问题分析、测试报告等文档已移至归档目录：

- [文件管理归档目录](../備份與歸檔/文件管理歸檔/) - 包含开发过程文件、测试报告、问题分析文档
...
- 更新文件上传架构说明文档（v3.0）：
  - 整合文件管理系統：文件操作功能、快捷鍵、批量操作、數據驗證規則
  - 整合狀態管理系統：上傳狀態、處理狀態、文件元數據記錄
  - 整合文件存儲系統：存儲後端選擇、本地文件系統、SeaweedFS/S3 存儲
  - 新增向量化系統：分塊策略、向量生成、向量存儲
  - 新增知識圖譜系統：Ontology 約束、增量提取機制、圖譜存儲
  - 更新參考文檔鏈接，指向核心架構文檔和歸檔文檔
- 整理文檔結構：
  - 核心架構文檔保留在 `核心组件/文件上傳向量圖譜/` 目錄
  - 開發過程文件移至 `備份與歸檔/文件管理歸檔/` 目錄
  - 更新 README.md 中的文檔鏈接
