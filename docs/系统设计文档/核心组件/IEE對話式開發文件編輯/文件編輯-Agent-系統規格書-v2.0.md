...
```json
{
  "doc_id": "uuid",
  "version_id": "uuid",
  "file_path": "data/tasks/{task_id}/workspace/{file_id}.xlsx",
  "task_id": "uuid",
  "user_id": "uuid",
  "tenant_id": "uuid"
}
...
{
  "source_doc_id": "uuid",
  "source_file_path": "data/tasks/{task_id}/workspace/{file_id}.md",
  "task_id": "uuid",
  "user_id": "uuid",
  "tenant_id": "uuid"
}
...
```json
{
  ...
  "source_doc_id": "uuid",
  "output_doc_id": "uuid",
  "output_file_path": "data/tasks/{task_id}/workspace/{output_file_id}.pdf",
...
{
  "source_doc_id": "uuid",
  "source_file_path": "data/tasks/{task_id}/workspace/{file_id}.xlsx",
  "task_id": "uuid",
  "user_id": "uuid",
  "tenant_id": "uuid"
}
...
{
  "source_doc_id": "uuid",
  "source_file_path": "data/tasks/{task_id}/workspace/{file_id}.pdf",
  "task_id": "uuid",
  "user_id": "uuid",
  "tenant_id": "uuid"
}
...
```json
{
  ...
  "source_doc_id": "uuid",
  "output_doc_id": "uuid",
  "output_file_path": "data/tasks/{task_id}/workspace/{output_file_id}.md",
  "status": "success|failed",
  "message": "conversion message",
  "metadata": {
    "page_count": 20,
...
- **文件存儲**：TaskWorkspaceService（任務工作區管理）
