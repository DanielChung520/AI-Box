...
用法:
  python grant_ai_consent.py --user-id <user_id>   # 為單一用戶寫入
  python grant_ai_consent.py --all                 # 為 user_tasks 中所有 user_id 寫入

建議: 使用後可移至 scripts/grant_ai_consent.py，並以 python scripts/grant_ai_consent.py 執行。
"""
