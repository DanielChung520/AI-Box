# 代碼功能說明: Excel 轉 PDF Agent 數據模型
# 創建日期: 2026-01-11
# 創建人: Daniel Chung
# 最後修改日期: 2026-01-11

"""Excel 轉 PDF Agent 數據模型
...
class ExcelConversionConfig(BaseModel):
    """Excel 轉換配置

    定義 Excel 到 PDF 的轉換配置。
    """
    ...
    options: Optional[Dict[str, Any]] = Field(
        None,
        description="轉換選項（worksheets, page_size, orientation, scale, margin 等）",
    )
